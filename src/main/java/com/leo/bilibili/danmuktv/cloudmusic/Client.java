package com.leo.bilibili.danmuktv.cloudmusic;
...
public class Client {
	...
	public static void main(String[] args) {
		String musicUrl = getMusicURL("326695");
