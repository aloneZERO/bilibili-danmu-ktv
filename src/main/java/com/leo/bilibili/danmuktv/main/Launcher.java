package com.leo.bilibili.danmuktv.main;
...
import com.leo.bilibili.danmuktv.cloudmusic.Client;
import com.leo.bilibili.danmuktv.core.ConnectServer;
import com.leo.bilibili.danmuktv.core.DefaultMusicList;
import com.leo.bilibili.danmuktv.core.DelectThread;
import com.leo.bilibili.danmuktv.core.MsgBuffer;
import com.leo.bilibili.danmuktv.core.Music;
import com.leo.bilibili.danmuktv.core.MusicFilter;
import com.leo.bilibili.danmuktv.core.MusicList;
import com.leo.bilibili.danmuktv.core.MusicListBuffer;
import com.leo.bilibili.danmuktv.core.MusicPlayer;
import com.leo.bilibili.danmuktv.core.ReceiveMsg;
import com.leo.bilibili.danmuktv.utils.Mp3Player;

/**
 * 点歌姬启动~
 * 
 * @author BlindingDark, aloneZero
 */
public class Launcher {

	// 维持一个与弹幕服务器的连接（30s发送一个心跳）
	ConnectServer connect = new ConnectServer(1010, 7178767);
	...
	public void putThisMusic(String _music) {
		Music music = Client.haveThisMusic(_music);
		if (!music.isMusic()) {
			System.out.println("+++++++++++++++");
